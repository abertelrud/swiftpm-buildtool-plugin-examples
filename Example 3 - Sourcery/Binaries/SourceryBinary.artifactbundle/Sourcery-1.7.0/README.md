...
If you want to generate code for asset related data like .xib, .storyboards etc. use [Sourcery](https://github.com/AliSoftware/Sourcery). Sourcery and Sourcery are complementary tools.
